...
<div class="message">
	...
	<span class="body">
		${comment.textHtml}
		<small id="chiefEditorToAssociateEditorBeforeReviewProcessDate${comment.revisionCount }"></small>
		<script type="text/javascript">
			document.getElementById("chiefEditorToAssociateEditorBeforeReviewProcessDate${comment.revisionCount }").innerHTML = "(" + convertUTCDateToLocalDate("${comment.date}", "${comment.time}", "${locale}") + ")";
		</script>
	</span>
</div>