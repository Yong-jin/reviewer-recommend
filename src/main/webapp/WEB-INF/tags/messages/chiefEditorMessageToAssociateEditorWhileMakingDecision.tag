...
<div class="message">
	...
	<span class="chatSubject">
		 <spring:message code="messages.chiefEditorToAssociateEditorWhileMakingDecision" htmlEscape="false"/>
	</span>
	<span class="body">
		${comment.textHtml} 
		<small id="chiefEditorToAssociateEditorWhileMakingDecision${comment.revisionCount + 1}"></small>
		<script type="text/javascript">
			document.getElementById("chiefEditorToAssociateEditorWhileMakingDecision${comment.revisionCount + 1}").innerHTML = "(" + convertUTCDateToLocalDate("${comment.date}", "${comment.time}", "${locale}") + ")";
		</script>
	</span>
</div>