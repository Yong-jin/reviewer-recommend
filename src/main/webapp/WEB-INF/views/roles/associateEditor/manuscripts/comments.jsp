						...
						<c:if test="${comment.revisionCount == index}">
							<c:choose>
								<c:when test="${comment.status == 'O'}">
									<c:choose>
										<c:when test="${comment.fromRole == 'ROLE_C-EDITOR' and comment.toUserId == user.id}">
											<li class="out">
...
<%-- 										<c:when test="${comment.fromRole == 'ROLE_REVIEWER'}">
											<c:choose>
												<c:when test="${comment.toRole == 'ROLE_A-EDITOR' and comment.toUserId == user.id}">
													<li class="out">
										...
										<c:when test="${comment.fromRole == 'ROLE_A-EDITOR' and comment.fromUserId == user.id}">
											<c:choose>
