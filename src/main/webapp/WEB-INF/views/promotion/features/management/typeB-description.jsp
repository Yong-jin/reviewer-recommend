<div class="row">
	<div class="col-md-6 profile-info">
		<h4 id="service-feature-title">1. <spring:message code='system.featureAndSupportTypeB'/></h4>
		<p><spring:message code="system.typeB.introduction"/></p>
		<table class="table table-bordered">
			...
			<tbody>
				<tr class="text-center" id="service-feature-table-tbody">
					<td><i class='fa fa-check-square-o'></i></td><td>&nbsp;</td><td><i class='fa fa-check-square-o'></i></td>
				</tr>
			</tbody>
		</table>
		...
		<h5>[<spring:message code="system.nosupport"/>]</h5>
		<h5><i class="fa fa-check red"></i> <spring:message code="user.role.journal_member"/></h5>
		<ul>
		...
		<h5><i class="fa fa-check red"></i> <spring:message code="user.role.journal_a-editor"/></h5>
		<ul>
			<li><spring:message code="system.supportDetails.a-editor2-no"/>
		</ul>
		<h5><i class="fa fa-check red"></i> <spring:message code="user.role.journal_reviewer"/></h5>
		<ul>
	...
	<div class="col-md-6">
		...
		<div class="text-center" id="manuscriptStatusImg">
			<c:if test="${locale == 'en_US' && (param.lang == null || param.lang == 'en_US')}">
				<img src="${baseUrl}/images/promotion/manuscriptStatusB.png" border="0" width="95%"/>
			</c:if>
			<c:if test="${locale == 'ko_KR' || param.lang =='ko_KR'}"> 
				<img src="${baseUrl}/images/promotion/manuscriptStatusB-Korean.png" border="0" width="95%"/>
			</c:if>
		</div>
		<br/><br/>
...
<p>
	<spring:message code="system.typeB.workFlow.indtroduction"/>
</p>
<div class="text-center">
	<c:if test="${locale == 'en_US' && (param.lang == null || param.lang == 'en_US')}">
		<img src="${baseUrl}/images/promotion/processTypeB.png" border="0" width="100%"/>
	</c:if>
	<c:if test="${locale == 'ko_KR' || param.lang =='ko_KR'}"> 
		<img src="${baseUrl}/images/promotion/processTypeB-Korean.png" border="0" width="100%"/>
	</c:if>
</div>