...
<div class="container">
	<div class="row">
		<div class="col-md-12">
			<ul class="page-breadcrumb breadcrumb marginTop14">
				...
				<li>
					<a href="${baseUrl}/promotion/customerSupport/faq">
						<spring:message code="system.faq"/>
					</a>
				</li>
			</ul>
		</div>
	...
	<div class="row">
		<div class="col-md-12">
			<!-- BEGIN PAGE TITLE-->
			<h3 class="page-title"><spring:message code="system.faq"/></h3>
			<hr/>
		</div>
	</div>
  <!-- END PAGE HEADER-->
	...
	<div class="row">
		<div class="col-md-3">
			<ul class="marginLeft0 ver-inline-menu tabbable">
				<li class="active">
				...
				<li>
					<a data-toggle="tab" href="#tab_4">
						<i class="fa fa-info-circle"></i> Payment Rules
					</a>
				</li>
				<li>
		...
		<div class="col-md-9">
			<div class="tab-content marginTop-11">
