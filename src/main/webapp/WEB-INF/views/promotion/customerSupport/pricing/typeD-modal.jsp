...
<body>
	<div class="modal-header">
	  ...
	  <h3><spring:message code="system.typeD2"/>. <spring:message code="system.nameTypeD"/></h3>
	</div>
	<div class="modal-body">
		<%@ include file="/WEB-INF/views/promotion/features/management/typeD-description.jsp" %>
	</div>
