...
<body>
	<div class="modal-header">
	  ...
	  <h3><spring:message code="system.typeC2"/>. <spring:message code="system.nameTypeC"/></h3>
	</div>
	<div class="modal-body">
		<%@ include file="/WEB-INF/views/promotion/features/management/typeC-description.jsp" %>
	</div>
