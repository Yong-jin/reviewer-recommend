...
<body>
	<div class="modal-header">
	  ...
	  <h3><spring:message code="system.typeB2"/>. <spring:message code="system.nameTypeB"/></h3>
	</div>
	<div class="modal-body">
		<%@ include file="/WEB-INF/views/promotion/features/management/typeB-description.jsp" %>
	</div>
