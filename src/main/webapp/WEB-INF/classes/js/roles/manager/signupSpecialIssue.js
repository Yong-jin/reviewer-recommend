var SignupSpecialIssue = function (baseUrl) {
	var handleRegister = function (baseUrl) {
        ...
        $('.register-form').validate({
            ...
            messages: {
                "title": {
                	required: "Please enter special issue title.",
                    minlength: jQuery.format("Please enter at least {0} characters."),
                    maxlength: jQuery.format("Please enter at most {0} characters."),
                },
                "description": {
                	required: "Please enter your special issue description.",
                    maxlength: jQuery.format("Please enter at most {0} characters."),
                }
            },
            ...
            submitHandler: function (form) {
    			...
    			$.ajax({
    				type: 'POST',
    				url: baseUrl + "/manager/configuration/specialIssues/createSpecialIssue",
    				data: parameter,
    				success: function(html){$('#register-form')[0].reset();
    				$.ajax({
						type: 'GET',
						url: baseUrl + "/manager/configuration/specialIssues/specialIssueTable",
						success: function(html){
							$("#specialIssueDisplay").html(html).show();
							App.scrollTo($('#specialIssueDisplay tr:last'));
