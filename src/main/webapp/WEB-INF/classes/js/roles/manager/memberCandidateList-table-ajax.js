var TableAjax = function (url, role) {

    var handleRecords = function(url, role) {
        var grid = new Datatable(url, role);
            ...
            grid.init({
                ...
                dataTable: {  // here you can define a typical datatable settings from http://datatables.net/usage/options 
                    ...
                    "bPaginate": true,
                    "bServerSide": true, 
                    "sAjaxSource": url + role + "CandidateTable", 
                    "aaSorting": [[ 1, "asc" ]], 
                    "aoColumnDefs": [
    ...
    return {
        ...
        init: function (url, role) {
            handleRecords(url, role);
        }
