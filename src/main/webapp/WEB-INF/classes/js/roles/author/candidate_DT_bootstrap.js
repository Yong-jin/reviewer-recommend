...
$.extend( true, $.fn.dataTable.defaults, {
	...
	//"sDom": "<'table-scrollable't><'row'<'col-md-5 col-sm-12'i><'col-md-7 col-sm-12'p>><'row'<'col-md-6 col-sm-12'l><'col-md-6 col-sm-12'f>r>", // horizobtal scrollable datatable
	//"sDom": "<'row'<'col-md-7 col-sm-12'lp><'globalSearchBar'>>rt<'row'>",
	...
	"sDom": "<'row'<'col-md-7 col-sm-12'l><'globalSearchBar'>>rt<'row'<'col-md-5 col-sm-12'><'col-md-7 col-sm-12'p>>",
        ...
        "fnInit": function( oSettings, nPaging, fnDraw ) {
			...
			*/
            $(nPaging).append(
                    ...
                    '<a href="#" class="btn btn-default prev disabled" title="' + oLang.sPrevious + '"><i class="fa fa-angle-left"></i></a>' +
                    '<input type="text" class="pagination-panel-input form-control input-mini input-inline input-sm" maxlenght="5" style="text-align:center; margin: 0 5px;">' + 
                    '<a href="#" class="btn btn-default next disabled" title="' + oLang.sNext + '"><i class="fa fa-angle-right"></i></a> ' +
                    '</div>'
            );
            var els = $('a', nPaging);
