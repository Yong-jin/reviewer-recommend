var TableAjax = function (url, pageType) {
    var handleRecordsAssigned = function(url, pageType) {
        var grid = new Datatable(url, pageType);
            ...
            $('#assignedTable_wrapper .dataTables_length select').addClass("form-control input-small marginRight30"); // modify table per page dropdown
            $('#assignedTable_wrapper .dataTables_length select').select2({
